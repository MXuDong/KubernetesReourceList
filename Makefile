...
darwin-amd64:
	GOARCH=amd64 GOOS=darwin $(GOBUILD) -o $(NAME)-$(VERSION)-$@/$(NAME) ${FILE}

linux-amd64:
	GOARCH=amd64 GOOS=linux $(GOBUILD) -o $(NAME)-$(VERSION)-$@/$(NAME) ${FILE}

windows-amd64:
    GOARCH=amd64 GOOS=windows $(GOBUILD) -o $(NAME)-$(VERSION)-$@/$(NAME) ${FILE}
